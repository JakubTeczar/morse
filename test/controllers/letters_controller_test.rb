...
class LettersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create letter" do
    assert_difference("Letter.count") do
      post letters_url, params: { letter: { letter: @letter.letter, morse_code: @letter.morse_code } }
    end
  ...
  test "should update letter" do
    patch letter_url(@letter), params: { letter: { letter: @letter.letter, morse_code: @letter.morse_code } }
